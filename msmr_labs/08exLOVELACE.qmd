...
`r qbegin(paste0(qcounter()," - optional"))`
...
The output is table, which we can ask to be sorted according to the `mi` column using `sort = TRUE`.  
...
The "Dimensions of Apathy" Scale is a measure of ... blah balah
