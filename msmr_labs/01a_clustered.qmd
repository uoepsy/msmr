...
#   lmer(grade~1+motiv+(1|schoolid),schoolmot)
#   lmer(grade~1+motiv+(1+motiv|schoolid),schoolmot) |> summary()
#   vv = summary(lmer(grade~1+motiv*funding+(1+motiv|schoolid),schoolmot))$optinfo$conv$lme4$messages
# # lmer(grade~1+motiv+(1|schoolid),schoolmot)
# v = abs(cov2cor(VarCorr(lmer(grade~1+motiv+(1+motiv|schoolid),schoolmot))[[1]])[1,2])<.7
# # lmer(grade~1+motiv*funding+(1+motiv|schoolid),schoolmot)
#   if(v & is.null(vv)){break}
# }
