...
- Make sure we're running models on only the data we are actually interested in. Are the healthy controls included in the research question under investigation?
...
m.recall.loc.effcoding <- 
    glmer(cbind(NumCorrect, NumError) ~ Phase * lesion_location + (Phase | ID), 
