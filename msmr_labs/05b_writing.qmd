...
Additionally, be sure to take some time to understand what the estimate actually means ($p<.05$ is just a small part of the story). With models like these we are almost always just looking at outcome "differences" between levels of a categorical predictor or "change" across some continuous predictor. Does the estimated difference/change, and it's direction, make sense to you? What does it mean practically? Asking yourself questions like this is also a good way of sense checking your analysis (i.e. a strong counter-intuitive finding _could_ mean you have a variable coded back to front!).  
...
- results of model comparisons and what they mean  
