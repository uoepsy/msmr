...
cmaterials <- cmaterials %>% transmute(
  ...
  Workbook = case_when(
    ...
    !is.na(lab) & nchar(lablink)==0 ~ paste0('<span style="opacity:0.8;">',lab,'</span>'),
    TRUE ~ ""
  )
)
...
courseicons = list(dapr1 = '<span class="iconify" data-icon="carbon:chart-candlestick" data-inline="false" data-width="60px" data-height="60px"></span>',
                   ...
                   msmr = '<span class="iconify" data-icon="fluent:bezier-curve-square-20-filled" data-width="60px" data-height="60px"></span>',
